...
<template>
  <div>
    <div class="bg-white dark:bg-[#061a15] rounded-lg grid sm:grid-cols-1 md:grid-cols-4 p-4">
      <div class="flex">
        <span>
                ...
                <td>
                  <div class="flex items-center overflow-hidden" style="max-width: 300px">
                    ...
                    <div class="flex flex-col">
                      <span class="text-sm text-primary dark:text-[#3fb68b] whitespace-nowrap overflow-hidden">
                        <RouterLink
                          :to="{
