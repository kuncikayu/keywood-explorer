...
<template>
  <div>
    ...
    <div v-if="tx.tx_response" class="bg-white dark:bg-[#061a15] px-4 pt-3 pb-4 rounded shadow mb-4">
        ...
        <table class="table text-sm">
          <tbody>
            ...
            <tr>
              ...
              <td>
                <RouterLink :to="`/${props.chain}/block/${tx.tx_response.height}`" class="text-primary dark:text-[#3fb68b]"
    ...
    <div v-if="tx.tx_response" class="bg-white dark:bg-[#061a15] px-4 pt-3 pb-4 rounded shadow">
