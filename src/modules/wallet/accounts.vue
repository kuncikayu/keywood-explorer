  ...
  <div>
    ...
    <div class="overflow-x-auto">
      <div
        ...
        class="bg-white dark:bg-[#061a15] rounded-md my-5 py-5"
      >
        <div class="flex justify-self-center">
          <div class="mx-2 p-2">
            <svg
              :fill="chainStore.current?.themeColor || '#a78bfa'"
              height="28px"
              width="28px"
              version="1.1"
              id="Capa_1"
      ...
      <div class="text-center bg-white dark:bg-[#061a15] rounded-md my-4 p-4">
        <a
          href="#address-modal"
